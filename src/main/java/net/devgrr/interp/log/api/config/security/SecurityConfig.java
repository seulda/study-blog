package net.devgrr.interp.log.api.config.security;

import com.fasterxml.jackson.databind.ObjectMapper;
import lombok.RequiredArgsConstructor;
import net.devgrr.interp.log.api.jwt.JwtService;
import net.devgrr.interp.log.api.jwt.filter.JwtAuthenticationProcessingFilter;
import net.devgrr.interp.log.api.login.LoginService;
import net.devgrr.interp.log.api.login.filter.JsonUsernamePasswordAuthenticationFilter;
import net.devgrr.interp.log.api.login.handler.LoginFailureHandler;
import net.devgrr.interp.log.api.login.handler.LoginSuccessJWTProvideHandler;
